...
@SpringBootTest(
    ...
    properties = {
      ...
      // Override is currently required when using MDM as the construction of the MDM beans are
      // ambiguous as they are constructed multiple places. This is evident when running in a spring
      // boot environment
