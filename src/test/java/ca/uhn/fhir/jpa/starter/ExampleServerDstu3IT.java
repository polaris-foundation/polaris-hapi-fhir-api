...
public class ExampleServerDstu3IT implements IServerSupport {
  ...
  private static final org.slf4j.Logger ourLog =
      org.slf4j.LoggerFactory.getLogger(ExampleServerDstu2IT.class);
  ...
  void beforeEach() {
    ...
    ourClient.registerInterceptor(
        new BasicAuthInterceptor("SensyneHealth", "UnbelievablyComplexPassword123qwerty"));
  }
  ...
  // ca.uhn.fhir.rest.server.exceptions.InternalErrorException: HTTP 500 : Failed to call access
  // method: java.lang.IllegalArgumentException: Could not load library source for libraries
  // referenced in Measure/Measure/measure-EXM104-FHIR3-8.1.000/_history/1.
  // @Test
  ...
  private Bundle loadBundle(String theLocation, FhirContext theCtx, IGenericClient theClient)
      throws IOException {
  ...
  public void testWebsocketSubscription() throws Exception {
    ...
    SocketImplementation mySocketImplementation =
        new SocketImplementation(mySubscriptionId.getIdPart(), EncodingEnum.JSON);
