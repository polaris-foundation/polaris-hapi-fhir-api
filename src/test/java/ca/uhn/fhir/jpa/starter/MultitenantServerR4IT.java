  ...
  public void testCreateAndReadInTenantA() {
    ...
    ourClient
        ...
        .withParameter(
            ...
            new IntegerType(1))
        .andParameter(
            ProviderConstants.PARTITION_MANAGEMENT_PARTITION_NAME, new CodeType("TENANT-A"))
        .execute();
  ...
  public void testCreateAndReadInTenantB() {
    ...
    ourClient
        ...
        .withParameter(
            ...
            new IntegerType(2))
        .andParameter(
            ProviderConstants.PARTITION_MANAGEMENT_PARTITION_NAME, new CodeType("TENANT-B"))
        .execute();
