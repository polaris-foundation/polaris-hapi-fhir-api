...
public class AppProperties {
  ...
  private String server_client_id = null;
  private String server_client_secret = null;
  ...
  public void setDefer_indexing_for_codesystems_of_size(
      Integer defer_indexing_for_codesystems_of_size) {
  ...
  public void setEnable_repository_validating_interceptor(
      Boolean theEnable_repository_validating_interceptor) {
  ...
  public void setNormalized_quantity_search_level(
      NormalizedQuantitySearchLevel normalized_quantity_search_level) {
  ...
  public String getServer_client_secret() {
    return this.server_client_secret;
  }

  public void setServer_client_id(String server_client_id) {
    this.server_client_id = server_client_id;
  }

  public void setServer_client_secret(String server_client_secret) {
    this.server_client_secret = server_client_secret;
  }
  ...
  public static class Logger {
    ...
    private String format =
        "Path[${servletPath}] Source[${requestHeader.x-forwarded-for}] Operation[${operationType}"
            + " ${operationName} ${idOrResourceName}] UA[${requestHeader.user-agent}]"
            + " Params[${requestParameters}] ResponseEncoding[${responseEncodingNoDefault}]"
  ...
  public static class Partitioning {
    ...
    public void setPartitioning_include_in_search_hashes(
        Boolean partitioning_include_in_search_hashes) {
